...
$page_text = getTranslation('redeemed_voucher', $lang);
...
$sql = "SELECT a.*,b.title FROM `tbl_users_vouchers` as a INNER JOIN tbl_voucher as b On a.`voucher_id` = b.id Where a.`user_id` = $my_user_id_is AND  a.redaem_time != '' AND a.`is_delete` = 0
 $searchCondition $filterCondition  ORDER BY a.`redaem_time` DESC LIMIT $offset, $recordsPerPage";
$result = $conn->query($sql);
$sql_mobile = $sql;

// Query to count total records with search
$countSql = "SELECT COUNT(*) as  total FROM `tbl_users_vouchers` as a INNER JOIN tbl_voucher as b On a.`voucher_id` = b.id  Where a.`user_id` = $my_user_id_is AND  a.redaem_time != '' AND a.`is_delete` = 0  $searchCondition $filterCondition";
...
<head>
    ...
    <title><?= getTranslation('redeemed_voucher', $lang) ?></title>
    <title></title>
    <!-- This page CSS -->
    <!-- chartist CSS -->
                                        ...
                                        <div class="row single_div_io pointer" id="<?php echo $id; ?>"
                                            ...
                                            <div class="col-12">
                                                <div class="row">
                                                    ...
                                                    <div class="col-12 mt-2">
                                                        <h6 class="dark_gray_color">
                                                            <b><?= getTranslation('voucher', $lang) ?>:</b>
                                                            <?php echo $title; ?></h6>
                                                    </div>
                                                    ...
                                                    <div class="col-12 mt-2">
                                                        <h6 class="dark_gray_color">
                                                            <b><?= getTranslation('amount', $lang) ?>:</b>
                                                            <?php echo $amount; ?>
                                                        </h6>
                                                    </div>
                                                    ...
                                                    <div class="col-12 mt-2">
                                                        <h6 class="dark_gray_color">
                                                            <b><?= getTranslation('transaction_id', $lang) ?>:</b>
                                                    ...
                                                    <div class="col-12 mt-2">
                                                        <h6 class="dark_gray_color">
                                                            <b><?= getTranslation('created_date', $lang) ?>:</b>
                                                            <?php echo $p_time; ?></h6>
                                                    </div>
