...
$promo_code_id = isset($_GET['id']) ? intval($_GET['id']) : 0;
$promo_code = null;
if ($promo_code_id > 0) {
    $sql = "SELECT `code`, `discount_type`, `discount_value`, `max_uses`, `start_date`, `end_date`, `what`, `voucher_id`, `category_id`
            FROM `tbl_promocodes`
            WHERE `promo_code_id` = $promo_code_id AND `is_delete` = 0 AND `user_id` = $my_user_id_is";
    $result = $conn->query($sql);
    if ($result && $result->num_rows > 0) {
        $promo_code = $result->fetch_assoc();
    } else {
        echo '<script type="text/javascript">window.location.href = "hotel_promo_code.php";</script>';
    }
} else {
    echo '<script type="text/javascript">window.location.href = "hotel_promo_code.php";</script>';
}

$page_text = getTranslation('edit_promo_code', $lang);
$back = 'yes';
?>
...
<head>
    ...
    <title><?= getTranslation('edit_promo_code', $lang) ?></title>
...
<body class="skin-default-dark fixed-layout mini-sidebar lock-nav">
    <div class="preloader">
        <div class="loader">
            ...
            <p class="loader__label"><?= getTranslation('edit_promo_code', $lang) ?></p>
        </div>
    </div>
    <div id="main-wrapper">
                ...
                <div class="mobile-container-padding">
                    <div class="row page-titles mb-3 add_background">
                        <div class="col-lg-12 col-xlg-12 col-md-12">
                            <span class="add_top_heading"><?= getTranslation('edit_promo_code', $lang) ?></span>
                        </div>
                        <div class="col-lg-12 col-xlg-12 col-md-12">
                            <hr>
                        </div>
                        <div class="col-lg-6 col-xlg-6 col-md-6">
                            <div class="input-container">
                                ...
                                <input type="text" class="form-control input_background" id="code" value="<?= htmlspecialchars($promo_code['code']) ?>" placeholder="">
                        ...
                        <div class="col-lg-6 col-xlg-6 col-md-6">
                            <div class="input-container">
                                ...
                                <select class="select2 m-b-10 select2-multipleselect2 form-control custom-select" id="discount_type" name="discount_type">
                                    <option value="PERCENTAGE" <?= $promo_code['discount_type'] == 'PERCENTAGE' ? 'selected' : '' ?>>
                                        <?= getTranslation('PERCENTAGE', $lang) ?>
                                    </option>
                                    <option value="FIXED" <?= $promo_code['discount_type'] == 'FIXED' ? 'selected' : '' ?>>
                                        <?= getTranslation('FIXED', $lang) ?>
                                    </option>
                                </select>
                        ...
                        <div class="col-lg-6 col-xlg-6 col-md-6">
                            <div class="input-container">
                                ...
                                <input type="number" class="form-control input_background" id="discount_value" value="<?= htmlspecialchars($promo_code['discount_value']) ?>" min="0" step="0.01" placeholder="">
                        ...
                        <div class="col-lg-6 col-xlg-6 col-md-6">
                            <div class="input-container">
                                ...
                                <input type="number" class="form-control input_background" id="max_uses" value="<?= htmlspecialchars($promo_code['max_uses']) ?>" placeholder="0 for unlimited" min="0">
                        ...
                        <div class="col-lg-6 col-xlg-6 col-md-6">
                            <div class="input-container">
                                ...
                                <input type="date" class="form-control input_background" id="start_date" value="<?= date('Y-m-d', strtotime($promo_code['start_date'])) ?>" placeholder="">
                        ...
                        <div class="col-lg-6 col-xlg-6 col-md-6">
                            <div class="input-container">
                                ...
                                <input type="date" class="form-control input_background" id="end_date" value="<?= date('Y-m-d', strtotime($promo_code['end_date'])) ?>" placeholder="">
                        ...
                        <div class="col-lg-12 col-xlg-12 col-md-12">
                            <div class="input-container">
                                ...
                                <select class="form-control input_background" id="apply_type" name="apply_type">
                                    <option value="all" <?= $promo_code['what'] == 'all' ? 'selected' : '' ?>>
                                        <?= getTranslation('all', $lang) ?>
                                    </option>
                                    <option value="voucher" <?= $promo_code['what'] == 'voucher' ? 'selected' : '' ?>>
                                        <?= getTranslation('voucher', $lang) ?>
                                    </option>
                                    <option value="category" <?= $promo_code['what'] == 'category' ? 'selected' : '' ?>>
                                        <?= getTranslation('category', $lang) ?>
                                    </option>
                                </select>
                                <div class="text-danger" id="errorapplytype"></div>
                            </div>
                        </div>
                        <div class="col-lg-12 col-xlg-12 col-md-12" id="voucher_container" style="display: <?= $promo_code['what'] == 'voucher' ? 'block' : 'none' ?>;">
                            <div class="input-container">
                                ...
                                <select class="form-control input_background" id="voucher_id" name="voucher_id">
                                    ...
                                    while ($row = $result_vouchers->fetch_assoc()) {
                                        $selected = $promo_code['voucher_id'] == $row['id'] ? 'selected' : '';
                        ...
                        <div class="col-lg-12 col-xlg-12 col-md-12" id="category_container" style="display: <?= $promo_code['what'] == 'category' ? 'block' : 'none' ?>;">
                            <div class="input-container">
                                ...
                                <select class="form-control input_background" id="category_id" name="category_id">
                                    ...
                                    while ($row = $result_categories->fetch_assoc()) {
                                        $selected = $promo_code['category_id'] == $row['id'] ? 'selected' : '';
                        ...
                        <div class="col-lg-6 col-xlg-6 col-md-6 mt-1">
                            <button class="btn btn-create btn-full-width" id="updateButton"><?= getTranslation('update', $lang) ?></button>
                        </div>
                    </div>
                </div>
            </div>
    ...
    document.addEventListener("DOMContentLoaded", function () {
        ...
        // Initialize Select2 for discount_type only
            ...
            if (document.querySelectorAll('.input-invalid').length === 0) {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        if (response == '1') {
                            Swal.fire({
                                title: '<?= getTranslation('updated_successfully', $lang) ?>',
                                type: 'success',
