...
$page_text = "Edit Destination Admin";
$back = 'yes';
                        ...
                        <div class="row page-titles mb-3 add_background">
                            ...
                            <div class="col-lg-6 col-xlg-6 col-md-6">
                                <div class="input-container">
                                    ...
                                    <input value="<?php echo $hotel_website; ?>" type="text" class="form-control input_background" id="website" placeholder="Address">
                    ...
                    if (
                        ...
                        $.ajax({
                            ...
                            success:function(response){
                                ...
                                if(response == '1'){
                                    Swal.fire({
                                        title: 'City Admin Edit Successfully',
                                        type: 'success',
