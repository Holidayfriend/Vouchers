...
$page_text = getTranslation('edit_categoery', $lang);
$back = 'yes';
...
$sql = "SELECT * FROM `tbl_category`  WHERE `user_id` =  '$my_user_id_is' AND `is_delete` = 0 AND `id` = $id ";
...
<head>
    ...
    <title><?= getTranslation('edit_categoery', $lang) ?></title>
    <!-- This page CSS -->
    <!-- chartist CSS -->
...
<body class="skin-default-dark fixed-layout mini-sidebar lock-nav">
    ...
    <div class="preloader">
        <div class="loader">
            ...
            <p class="loader__label"><?= getTranslation('edit_categoery', $lang) ?></p>
        </div>
    </div>
    <!-- ============================================================== -->
                ...
                <div class="mobile-container-padding">
                    <div class="row page-titles mb-3 add_background">
                        <div class="col-lg-12 col-xlg-12 col-md-12">
                            <span class="add_top_heading"><?= getTranslation('edit_categoery', $lang) ?></span>
                        </div>
                        ...
                        <div class="col-lg-6 col-xlg-6 col-md-6">
                            <div class="input-container">
                                ...
                                <input value="<?php echo $name;  ?>" type="text" class="form-control input_background" id="title" placeholder="">
                                <div class="text-danger" id="errortitle"></div>
                            </div>
                        </div>
                        <div class="col-lg-6 col-xlg-6 col-md-6">
                            <div class="form-check form-switch mt-4 p-4">
                                <input <?php echo $check; ?> class="form-check-input" type="checkbox" id="check">
                        ...
                        <div class="col-lg-6 col-xlg-6 col-md-6 mt-1">
                            <button class="btn btn-create btn-full-width" id="createButton"><?= getTranslation('edit', $lang) ?></button>
                        </div>
