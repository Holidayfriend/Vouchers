...
$page_text = getTranslation('unused_voucher', $lang);
...
if (!empty($search)) {
    $searchCondition = "AND (a.`first_name` = '$search' OR a.`qr_code` LIKE '%$search%' OR a.`title` LIKE '%$search%' 
...
$sql = "SELECT a.*,b.title FROM `tbl_users_vouchers` as a INNER JOIN tbl_voucher as b On a.`voucher_id` = b.id Where a.`user_id` = $my_user_id_is AND  a.redaem_time  is NULL AND a.`is_delete` = 0
...
$countSql = "SELECT COUNT(*) as  total FROM `tbl_users_vouchers` as a INNER JOIN tbl_voucher as b On a.`voucher_id` = b.id AND a.`is_delete` = 0
Where a.`user_id` = $my_user_id_is AND  a.redaem_time is NULL
...
<head>
    ...
    <link rel="icon" type="image/png" sizes="16x16" href="./assets/images/favicon.png">
     <title><?= getTranslation('unused_voucher', $lang) ?></title>
    <title></title>
    <!-- This page CSS -->
    <!-- chartist CSS -->
                                    ...
                                    <table class="table">
                                        <thead>
                                            <tr>
                                                ...
                                                <th><?= getTranslation('view_detail', $lang) ?></th>
                                        ...
                                        <tbody>
                                            <?php while ($row = $result->fetch_assoc()):
                                                ...
                                                $transaction_id = 'Internal Voucher';
                                                if ($id > 0) {
                                                    $sql_c = "SELECT `transaction_id` FROM `tbl_transaction` WHERE `voucher_id` = $id";
                                                    ...
                                                    if ($row_c = mysqli_fetch_assoc($result_c)) {
                                                        ...
                                                        $transaction_id = $row_c['transaction_id'];
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="checkbox-header"><input type="checkbox" class="userCheckbox"
                                                     ...
                                                     <td class="text-left"><span class=" "><?php echo $qr_code; ?></span>
                                                    </td>
                                                    <td class="">
                                                        <?php echo $first_name . ' ' . $last_name; ?>
                                                    </td>

                                                    <td class=""><span class=" "><?php echo $email; ?></span></td>
                                                    <td class=""><span class=" "><?php echo $title; ?></span></td>
                                                    <td class="text-center"><span class=" "><?php echo $amount; ?></span>
                                                    </td>
                                                   
                                                    <td class="text-center"><span class=" "><?php echo $total; ?></span>
                                                    </td>
                                                    <td class="text-center"><span
                                                            class=" "><?php echo $transaction_id; ?></span>
                                                    </td>
                                                    <td class="text-center"><span class=" "><?php echo $p_time; ?></span>
                                                    </td>


                                                    <td class=" text-center">

                                                        <a href="hotel_purchased_voucher_detail.php?id=<?php echo $id ?>"><i
                                                                class="ti-eye">
                                                            </i></a>
                                            ...
                                            <div class="col-12">
                                                <div class="row">
                                                    ...
                                                    <div class="col-12 mt-2">
                                                        <h6 class="dark_gray_color"><b>QR Code:</b> <?php echo $qr_code; ?>
                                                        </h6>
                                                    </div>

                                                    <!-- Name -->
                                                    <div class="col-12 mt-2">
                                                        <h6 class="dark_gray_color"><b><?= getTranslation('name', $lang) ?>:</b>
                                                            <?php echo $first_name . ' ' . $last_name; ?></h6>
                                                    </div>

                                                    <!-- Email -->
                                                    <div class="col-12 mt-2">
                                                        <h6 class="dark_gray_color"><b><?= getTranslation('email', $lang) ?>:</b> <?php echo $email; ?></h6>
                                                    </div>

                                                    <!-- Title -->
                                                    <div class="col-12 mt-2">
                                                        <h6 class="dark_gray_color"><b><?= getTranslation('voucher', $lang) ?>:</b> <?php echo $title; ?></h6>
                                                    </div>

                                                    <!-- Amount -->
                                                    <div class="col-12 mt-2">
                                                        <h6 class="dark_gray_color"><b><?= getTranslation('amount', $lang) ?>:</b> <?php echo $amount; ?>
                                                        </h6>
                                                    </div>

                                                    <!-- Transaction ID -->
                                                    <div class="col-12 mt-2">
                                                        <h6 class="dark_gray_color"><b><?= getTranslation('transaction_id', $lang) ?>:</b>
                                                            <?php echo $transaction_id; ?></h6>
                                                    </div>

                                                    <!-- Purchase Time -->
                                                    <div class="col-12 mt-2">
                                                        <h6 class="dark_gray_color"><b><?= getTranslation('created_date', $lang) ?>:</b>
                                                            <?php echo $p_time; ?></h6>
                                                    </div>
...
$("#deleteButtonm").click(function () {
                ...
                $.ajax({
                    type: "POST",
                    url: "utill/del.php",
                    data: { selectedRows: selectedIds, base: 'users_vouchers', base_name: 'id' },
                    success: function (response) {
            ...
            $("#deleteButton").click(function () {
                ...
                $.ajax({
                    type: "POST",
                    url: "utill/del.php",
                    data: { selectedRows: selectedRows, base: 'users_vouchers', base_name: 'id' },
                    success: function (response) {
                        // Display the response message from del.php (e.g., success or error message)
                        // After successful deletion, refresh the page
