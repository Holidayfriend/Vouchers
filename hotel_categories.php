...
$page_text = getTranslation('categories', $lang);
...
if (!empty($search)) {
    $searchCondition = "AND (`name` = '$search' OR `name_de` LIKE '%$search%')";
} else {
    $searchCondition = '';
}
...
$sql = "SELECT * FROM `tbl_category` WHERE `user_id` =  $my_user_id_is AND is_delete = 0 $searchCondition $filterCondition ";
$result = $conn->query($sql);
$sql_mobile = $sql;

// Query to count total records with search
$countSql = "SELECT COUNT(*) as total FROM `tbl_category`  WHERE `user_id` =  $my_user_id_is AND is_delete = 0 $searchCondition $filterCondition";
...
<head>
    ...
    <title><?= getTranslation('categories', $lang) ?></title>
    <!-- This page CSS -->
    <!-- chartist CSS -->
                    ...
                    <div class="row page-titles mb-3  ">
                        <div class="col-md-12">
                            <div class="row mt-3">
                                <div class="col-md-6">
                                    <span id="rowCount"><b
                                            class="text_black_color"><?= getTranslation('category_list', $lang) ?>(</b><b
                                ...
                                <div class="col-md-6 text-right">
                                    ...
                                    <button onclick="url_redirect('hotel_add_category.php')" class="btn btn-add"
                                        id="addButton"> <i
                                            class="mdi mdi-plus"></i><?= getTranslation('add_categoery', $lang) ?></button>
                                </div>
                            </div>
                            <div class="row mt-3">
                                ...
                                if (mysqli_num_rows($result_mobile) > 0) {
                                    while ($row = mysqli_fetch_array($result_mobile)) {
                                        ...
                                        if ($row['is_fixed'] == 1) {
                                            if ($lang == 'de') {
                                                $is_fixed = 'Fester Betrag';
                                            } elseif ($lang == 'it') {
                                                $is_fixed = 'Valore fisso';
                                            } else {
                                                $is_fixed = 'Amount is Fixed';
                                            }
                                        } else {
                                            if ($lang == 'de') {
                                                $is_fixed = 'Preis personalisierbar';
                                            } elseif ($lang == 'it') {
                                                $is_fixed = 'Valore personalizzabile';
                                            } else {
                                                $is_fixed = 'Amount is Not Fixed';
                                            }
                                        }
                                                ...
                                                <div class="col-lg-12 ">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-12 text-right">
                                                            <a href="hotel_edit_category.php?id=<?php echo $id; ?>">
                                                                <span class="single_div__dark_text edit_hover"> <i
                                                        ...
                                                        <div class="col-12 mt-2">
                                                            <h5 class="dark_gray_color"><b><?php echo $name; ?></b> </h5>
                                                        </div>

                                                        <div class="col-12 mt-2">
                                                            <!-- Second Column - Name -->
                                                            <span class=""><?php echo $is_fixed; ?></span>
                                                            <br>
                                                        </div>
                                    ...
                                    <div style="text-align: center;">
                                        <h3 style="margin: 0; padding: 20px; color: #333;">
                                            <?= getTranslation('not_found', $lang) ?></h3>
                                    </div>
        ...
        $(document).ready(function () {
            ...
            $("#deleteButton").click(function () {
                ...
                $.ajax({
                    type: "POST",
                    url: "utill/del.php",
                    data: { selectedRows: selectedIds, base: 'category', base_name: 'id' },
                    success: function (response) {
